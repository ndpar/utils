...
class SortTest {
    ...
    void testDualPivotQuicksortLargeCenterPart() {
        int[] array = [90, 47, 58, 29, 42, 32, 55, 55, 55, 43, 58, 50, 40, 55, 59, 46, 44, 40, 46, 44, 29, 68, 75, 97, 24,
                       40, 41, 42, 37, 49, 43, 92, 51, 92, 39, 15, 43, 39, 36, 69, 40, 16, 23, 42, 39, 91, 57, 43, 55, 22]
        Arrays.sort(array)
        assert false
    }
