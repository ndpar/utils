...
class SortTest {
    ...
    void testDualPivotQuicksortLargeCenterPart() {
        ...
        Arrays.sort(array)
        assert array == [15, 16, 22, 23, 24, 29, 29, 32, 36, 36, 37, 39, 39, 39, 40, 40, 40, 40, 42, 42, 42, 43, 43, 43, 43,
                         44, 44, 46, 46, 47, 49, 50, 51, 55, 55, 55, 55, 57, 58, 58, 58, 59, 68, 69, 75, 90, 91, 92, 92, 97]
    }
    ...
    void testQuicksortEqualElements() {
        ...
        Arrays.sort(array)
        assert array == [2, 5, 5, 8, 9, 15, 16, 21, 22, 22, 23, 24, 29, 29, 29, 32, 34, 39, 40, 40, 40, 40, 40, 43, 43,
                         46, 46, 47, 50, 51, 55, 55, 55, 57, 58, 58, 63, 69, 69, 73, 75, 77, 82, 84, 89, 90, 91, 92, 92, 97]
    }
